    ...
    return (
        <div className={styles.loginAndLogout}>
         <div className={styles.shell}>
             <div className={`${styles.container} ${styles.aContainer}`} id="a-container">
                ...
                {/* eslint-disable-next-line react/button-has-type */}
                   <button className={`${styles.form_button} ${styles.button} ${styles.submit}`} onClick={changeForm}>
                     SIGN UP
                   </button>
                 </form>
             </div>
             ...
             >
                <form action="" method="" className={styles.form} id="b-form">
                    ...
                    {/* eslint-disable-next-line react/button-has-type */}
                    <button className={`${styles.formButton} ${styles.button} ${styles.submit}`} onClick={changeForm}>
                        SIGN IN
                    </button>
                </form>
             </div>
            ...
            <div className={styles.switch} id="switch-cnt">
                ...
                <div className={`${styles.switch_circle} ${styles.switch_circle_t} }`} />
                <div className={styles.switch_container} id="switch-c1">
                    ...
                    {/* eslint-disable-next-line react/button-has-type */}
                    <button className={`${styles.switch_button} ${styles.button} `} onClick={changeForm}>SIGN IN</button>
                </div>
            </div>

                <div className={`${styles.switchContainer} ${styles.isHidden}`} style={{ letterSpacing: 0 }} id="switch-c2">
                    <h2 className={`${styles.switch_title} ${styles.title}`}>Hello Friend！</h2>
                    <p className={`${styles.switch_description} ${styles.description}`}>去注册一个账号，成为尊贵的粉丝会员，让我们踏入奇妙的旅途！</p>
                    {/* eslint-disable-next-line react/button-has-type */}
                    <button className={`${styles.switchButton} ${styles.button}`} onClick={changeForm}>
                        SIGN UP
                    </button>
                </div>
         </div>
